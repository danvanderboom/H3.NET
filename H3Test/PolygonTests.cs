...
namespace H3Test
{
    ...
    {
        static GeoCoord[] sfVerts = new GeoCoord[]
        {
        ...
        //static LinkedGeoLoop createLinkedLoop(GeoCoord* verts, int numVerts)
        //{
        ...
        //    t_assert(!pointInsideGeofence(&geofence, &bbox, &sfVerts[0]), "contains exact");
        //    t_assert(pointInsideGeofence(&geofence, &bbox, &sfVerts[4]), "contains exact 4");
        //    t_assert(pointInsideGeofence(&geofence, &bbox, &inside), "contains point inside");
        //    t_assert(!pointInsideGeofence(&geofence, &bbox, &somewhere), "contains somewhere else");
        //}
        ...
        //    t_assert(pointInsideLinkedGeoLoop(&loop, &bbox, &inside), "contains exact4");
        //    t_assert(!pointInsideLinkedGeoLoop(&loop, &bbox, &somewhere), "contains somewhere else");
        ...
        //    t_assert(!isClockwiseLinkedGeoLoop(&loop), "Got false for counter-clockwise loop");
        ...
        //    t_assert(isClockwiseLinkedGeoLoop(&loop), "Got true for clockwise transmeridian loop");
        ...
        //    t_assert(!isClockwiseLinkedGeoLoop(&loop), "Got false for counter-clockwise transmeridian loop");
        ...
        //    t_assert(countLinkedLoops(&polygon) == 1, "Loop count on first polygon correct");
        //    t_assert(countLinkedLoops(polygon.next) == 1, "Loop count on second polygon correct");
        ...
        //    t_assert(countLinkedPolygons(&polygon) == 1, "Polygon count correct");
        //    t_assert(countLinkedLoops(&polygon) == 2, "Loop count on first polygon correct");
        ...
        //    t_assert(countLinkedPolygons(&polygon) == 1, "Polygon count correct for 2 holes");
        //    t_assert(polygon.first == outer, "Got expected outer loop");
        //    t_assert(countLinkedLoops(&polygon) == 3, "Loop count on first polygon correct");
        ...
        //    t_assert(countLinkedCoords(polygon.first->next) == 3, "Got expected inner loop");
        //    t_assert(countLinkedLoops(polygon.next) == 2, "Loop count on second polygon correct");
        //    t_assert(countLinkedCoords(polygon.next->first) == 4, "Got expected outer loop");
        //    t_assert(countLinkedCoords(polygon.next->first->next) == 3, "Got expected inner loop");
        ...
        //    t_assert(result == NORMALIZATION_ERR_UNASSIGNED_HOLES, "Expected error code returned");

        //    t_assert(countLinkedPolygons(&polygon) == 1, "Polygon count correct");
        //    t_assert(countLinkedLoops(&polygon) == 0, "Loop count as expected with invalid input");
        ...
        //    t_assert(result == NORMALIZATION_ERR_MULTIPLE_POLYGONS, "Expected error code returned");
